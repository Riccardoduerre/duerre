    ...
    <section className="bg-theme-bg py-24">
      <div className="container mx-auto px-6 md:px-8">
        <div className="mb-16 text-center">
          <p className="text-xs uppercase tracking-[0.34em] text-theme-accent">{t('blog')}</p>
          <h1 className="mt-4 text-4xl font-bold uppercase tracking-[0.22em] md:text-6xl">{t('blog')}</h1>
        </div>
